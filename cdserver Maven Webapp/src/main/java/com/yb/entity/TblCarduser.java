...
public class TblCarduser {
	...
	private BigDecimal anonymousbalance;
	...
	private BigDecimal currentcardId;
	...
	public TblCarduser(BigDecimal carduserId, BigDecimal version,
			...
			BigDecimal anonymousbalance, BigDecimal p1,
			...
			BigDecimal isupdateclientinfo, BigDecimal currentcardId,
		...
		this.p2 = p2;
		this.anonymousbalance = anonymousbalance;
		this.p1 = p1;
	...
	public String toString() {
		return "TblCarduser [carduserId=" + carduserId + ", version=" + version
				...
				+ ", anonymousbalance=" + anonymousbalance + ", p1=" + p1
				...
				+ ", currentcardId=" + currentcardId + ", carmodelId="
				+ carmodelId + ", ismastercard=" + ismastercard + ", notes="
				+ notes + ", recnum=" + recnum + ", crstate=" + crstate
				+ ", opfstate=" + opfstate + ", osastate=" + osastate + "]";
	}
	...
	public BigDecimal getAnonymousbalance() {
		return anonymousbalance;
	}
	public void setAnonymousbalance(BigDecimal anonymousbalance) {
		this.anonymousbalance = anonymousbalance;
	}
	...
	public BigDecimal getCurrentcardId() {
		return currentcardId;
	}
	public void setCurrentcardId(BigDecimal currentcardId) {
		this.currentcardId = currentcardId;
	}
