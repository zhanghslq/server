...
public class TblCustomerController{
	...
	public Status insert(HttpServletRequest request,@RequestBody List<TblCustomer> list) throws IOException{
		try {
			...
			File file2 = new File(file, "TblCustomerController.txt");
			file2.createNewFile();
