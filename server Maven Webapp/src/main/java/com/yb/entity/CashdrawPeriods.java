...
public class CashdrawPeriods implements Serializable{
	...
	public CashdrawPeriods(Integer cdrawPeriod, Integer cashierId,
			Integer posId, Date cdrawOpenDate, Date cdrawCloseDate,
			Integer cdrawPeriodState) {
		super();
		this.cdrawPeriod = cdrawPeriod;
	...
	public String toString() {
		return "CashdrawPeriods [cdrawPeriod=" + cdrawPeriod + ", cashierId="
				+ cashierId + ", posId=" + posId + ", cdrawOpenDate="
				+ cdrawOpenDate + ", cdrawCloseDate=" + cdrawCloseDate
				+ ", cdrawPeriodState=" + cdrawPeriodState + "]";
	}
	public Integer getCdrawPeriod() {
		return cdrawPeriod;
	}
	public void setCdrawPeriod(Integer cdrawPeriod) {
		this.cdrawPeriod = cdrawPeriod;
	}
