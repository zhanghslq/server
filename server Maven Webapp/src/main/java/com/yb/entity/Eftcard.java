...
private String stationId;
	...
	public String toString() {
		return "Eftcard [transactionId=" + transactionId + ", itemNumber="
				...
				+ eftTrace + ", nowDate=" + nowDate + "]";
	}

	public Eftcard(Integer transactionId, Integer itemNumber,
			...
			Integer terminalTypeEnum, String eftTrace, Date nowDate) {
		super();
