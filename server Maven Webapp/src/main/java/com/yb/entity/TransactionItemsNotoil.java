...
public class TransactionItemsNotoil implements Serializable{
	...
	public TransactionItemsNotoil() {
		super();
		// TODO Auto-generated constructor stub
	}
	public TransactionItemsNotoil(Integer transactionId, Integer itemNumber,
			...
			String currencyCode, BigDecimal taxRate, String productCode) {
		super();
		this.transactionId = transactionId;
		this.itemNumber = itemNumber;
		this.itemType = itemType;
